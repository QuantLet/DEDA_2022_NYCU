...
raw_text= open(path.join(d, 'Lover_Taylor Swift.txt'), encoding = "utf8").read()
...
# Mask
xmas_tree_pic = np.array(Image.open(path.join(root_path, "Heart2.png")))
...
text_pre = open(path.join(d, 'Lover_Taylor Swift.txt'), encoding = "utf8").read()
