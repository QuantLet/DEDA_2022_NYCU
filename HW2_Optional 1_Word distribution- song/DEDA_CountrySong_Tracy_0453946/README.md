...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **DEDA_CountrySong_Tracy_0453946** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
![Picture2](plot_heatmap_countrysong.png)

![Picture3](plot_wordcloud_guitar.png)
...
raw_text= open(path.join(d, 'COUNTRY SONG.txt'), encoding = "utf8").read()
...
# Mask
xmas_tree_pic = np.array(Image.open(path.join(root_path, "guitar.png")))
...
# store to file
wc.to_file(path.join(root_path, "wordcloud_guitar.png"))
...
text_pre = open(path.join(d, 'COUNTRY SONG.txt'), encoding = "utf8").read()
...
plt.savefig("heatmap country song.png", transparent = True)
